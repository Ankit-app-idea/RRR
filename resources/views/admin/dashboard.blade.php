         ...
         <div class="col s12 m4">
            <div class="card animate fadeLeft">
               <div class="card-content  center">
                  ...
                  <img src="{{ asset('public/admin/app-assets/images/cards/watch.png')}}" alt="" class="responsive-img" />
         ...
         <div class="col s12 m4">
            <div class="card animate fadeUp">
               <div class="card-content center">
                  ...
                  <img src="{{ asset('public/admin/app-assets/images/cards/headphones-2.png')}}" alt="" class="responsive-img" />
               </div>
         ...
         <div class="col s12 m4">
            <div class="card animate fadeRight">
               <div class="card-content center">
                  ...
                  <img src="{{ asset('public/admin/app-assets/images/cards/iphonec.png')}}" alt="" class="responsive-img" />
         ...
         <div class="row">
            <div class="col s12 m3">
               <div class="card gradient-shadow gradient-45deg-light-blue-cyan border-radius-3 animate fadeUp">
                  <div class="card-content center">
                     <img src="{{ asset('public/admin/app-assets/images/icon/apple-watch.png')}}"
            ...
            <div class="col s12 m3">
               <div class="card gradient-shadow gradient-45deg-red-pink border-radius-3 animate fadeUp">
                  <div class="card-content center">
                     <img src="{{ asset('public/admin/app-assets/images/icon/printer.png')}}"
            ...
            <div class="col s12 m3">
               <div class="card gradient-shadow gradient-45deg-amber-amber border-radius-3 animate fadeUp">
                  <div class="card-content center">
                     <img src="{{ asset('public/admin/app-assets/images/icon/laptop.png')}}"
                        class="width-40 border-round z-depth-5 responsive-img" alt="image" />
            ...
            <div class="col s12 m3">
               <div class="card gradient-shadow gradient-45deg-green-teal border-radius-3 animate fadeUp">
                  <div class="card-content center">
                     <img src="{{ asset('public/admin/app-assets/images/icon/bowling.png')}}"
                        class="width-40 border-round z-depth-5 responsive-img" alt="image" />
            ...
            <ul class="widget-timeline mb-0">
              ...
              <li class="timeline-items timeline-icon-red active">
                ...
                <div class="timeline-content">
                  <img src="{{ asset('public/admin/app-assets/images/icon/pdf.png')}}" alt="document" height="30" width="25"
    ...
    <li class="chat-body">
      <ul class="collection">
        <li class="collection-item display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
          <span class="avatar-status avatar-online avatar-50"><img src="{{ asset('public/admin/app-assets/images/avatar/avatar-7.png')}}"
              alt="avatar" />
          </span>
