...
<!--                                <div class="col display-flex align-items-center show-btn">
                                ...
                                <div class="col s2 display-flex align-items-right show-btn">
                                    ...
                                    <a href="{{ url('admin/categories/add') }}" class="btn btn-block indigo waves-effect waves-light">Add</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                        ...
                                        @if(count($categories)>0)
                                            @foreach($categories as $cat)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/categories/edit',$cat->categories_id)}}"><i class="material-icons">edit</i></a></td>
                                                    <td><a href="{{ url('admin/categories/delete',$cat->categories_id) }}"><i class="material-icons">delete</i></a></td>
                                                </tr>
                                            @endforeach
                                       @else
                                       <tr>
