                  ...
                  <div class="card-content">
                    <div class="row">
                        <div class="col s12" id="account">                       
                           ...
                           <form class="accountForm" method="POST" action='{{ url('admin/sub-categories/update-categories') }}' aria-label="categories" enctype="multipart/form-data">
                                @csrf 
                                       ...
                                       <div class="col s6 input-field">
                                        ...
                                        <div class="col m6 input-field ">                                            
                                            <select class="select2 browser-default validate" required="required" title="main categories" data-plas id="select2-icons" name="main_categories">                                                
                                                ...
                                                <option value="{{$v->categories_id}}" 
                                                        @if($v->categories_id==$categories->parent_id) selected @endif
                                                        >{{$v->detail->categories_name}}</option>
                                                @endforeach    
                                            </select>
                                            <small class="errorTxt1"></small>
                                        </div>
