    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Sub Categories</span></h5>
            </div>
...
<!--                                <div class="col display-flex align-items-center show-btn">
                                    <button type="submit" class="btn btn-block indigo waves-effect waves-light">Show</button>
                                </div>-->
                                <div class="col s10"></div>

                                <div class="col s2 display-flex align-items-right show-btn">
                                 
                                    <a href="{{ url('admin/sub-categories/add') }}" class="btn btn-block indigo waves-effect waves-light">Add</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                        ...
                                        @if(count($subcategories)>0)
                                            @foreach($subcategories as $cat)
                                                <tr>
                                                    ...
                                                    <td>{{ $cat->detail->categories_name }}</td>
                                                    <td><img src="{{asset('').'/'.$cat->categories_image}}" alt="{{ $cat->categories_image }}" width=" 100px"></td>
                                                    <td><img src="{{asset('').'/'.$cat->categories_icon}}" alt="{{ $cat->categories_icon }}" width=" 100px"></td>
                                                    <td>{{ $cat->maindetail->detail->categories_name }}</td>
                                                    <td><a href="{{ url('admin/sub-categories/edit',$cat->categories_id)}}"><i class="material-icons">edit</i></a></td>
                                                    <td><a href="{{ url('admin/sub-categories/delete',$cat->categories_id) }}"><i class="material-icons">delete</i></a></td>
                                                </tr>
                                            @endforeach
                                       @else
                                       <tr>
