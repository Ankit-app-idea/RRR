                    ...
                    <div class="card-panel">
                        <div class="row">
                            <form>
                                ...
                                <div class="col s12 m6 l3">
                                    ...
                                    <div class="input-field">
                                        <select class="form-control" id="users-list-role">
                                            ...
                                            <option value="{{ $roles->type }}">{{ $roles->type }}</option>
                                            @endforeach
                                ...
                                <div class="col display-flex align-items-center show-btn">
                                    <br>
                                    <a href="{{ url('admin/add-new-user') }}" class="btn btn-block indigo waves-effect waves-light">Add</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <table id="users-list-datatable" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ url('admin/users-edit',$user->id)}}"><i class="material-icons">edit</i></a></td>
