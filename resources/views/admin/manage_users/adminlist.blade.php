                    ...
                    <div class="card-panel">
                        <div class="row">
                            <form>
                                ...
                                <div class="col s12 m6 l3 display-flex align-items-center show-btn">
                                    <a href="{{ url('admin/add-new-admin') }}" class="btn btn-block indigo waves-effect waves-light">ADD</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <table id="users-list-datatable" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ url('admin/admin-edit',$user->id)}}"><i class="material-icons">edit</i></a></td>
