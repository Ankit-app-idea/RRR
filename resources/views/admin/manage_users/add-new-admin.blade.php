...
<!--                      <div class="card-body"> 
                    <ul class="tabs mb-2 row">
                        <li class="tab">
                           ...
                           <i class="material-icons mr-1">person_outline</i><span>Add</span>
                           </a>
                        </li>
...
<!--                              <a class="mr-2" href="#">
                                <img src="{{ asset('public/admin/app-assets/images/avatar/avatar-11')}}.png" alt="users avatar" class="z-depth-4 circle"
                                 height="64" width="64">
                              </a>-->
<!--                              <div class="media-body">
                           ...
                           <!-- users edit account form start -->
                            <form class="accountForm" method="POST" action='{{ url('admin/create-admin') }}' aria-label="{{ __('Login') }}">
                                @csrf
