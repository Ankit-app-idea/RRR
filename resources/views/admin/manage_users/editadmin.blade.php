         ...
         <div class="container">
            <div class="row">
               <div class="col s10 m6 l6">
                  <h5 class="breadcrumbs-title mt-0 mb-0"><span>Admin edit</span></h5>
                     ...
                     <div class="row">
                        <div class="col s12" id="account">
                           ...
                           <!-- users edit account form start -->
                            <form class="accountForm" method="POST" action='{{ url('admin/update-admin-profile') }}' aria-label="{{ __('Login') }}">
                                @csrf
                                 ...
                                 <div class="col s12 m6">
                                    <div class="row">
                                       <div class="col s12 input-field">
                                          <input id="name" name="name" type="text" class="validate" value="{{ $admin->name }}"
                                             data-error=".errorTxt1">
                                          <label for="name">First Name</label>
                                          <small class="errorTxt1"></small>
                                       </div>
                                       <div class="col s12 input-field">
                                          <input id="email" name="email" type="text" class="validate" value="{{ $admin->email }}"
                                             data-error=".errorTxt1">
