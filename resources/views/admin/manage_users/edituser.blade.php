                     ...
                     <div class="row">
                        <div class="col s12" id="account">
                           ...
                           <!-- users edit account form start -->
                            <form class="accountForm" method="POST" action='{{ url('admin/update-user-profile') }}' aria-label="{{ __('Login') }}">
                                @csrf
                                 ...
                                 <div class="col s12 m6">
                                    <div class="row">
                                       <div class="col s12 input-field">
                                          <input id="f_name" name="f_name" type="text" class="validate" value="{{ $users->f_name }}"
                                             data-error=".errorTxt1">
                                          <label for="f_name">First Name</label>
                                          <small class="errorTxt1"></small>
                                       </div>
                                       <div class="col s12 input-field">
                                          <input id="l_name" name="l_name" type="text" class="validate" value="{{ $users->l_name }}"
                                             data-error=".errorTxt1">
                                    ...
                                    <div class="row">
                                       <div class="col s12 input-field">
                                           <select name="role">
                                               ...
                                               <option value="{{ $v->id }}" 
                                                       @if($v->id==$users->rolle_id) selected @endif
